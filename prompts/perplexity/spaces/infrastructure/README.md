...
- 'pegasus': a developer's machine with 128GB RAM and an ASUS ROG Astral RTC 5090 32GB GPU. It's purpose is for code development, small scale AI R&D and general computing for the developer. `inventory-pegasus.json`.
